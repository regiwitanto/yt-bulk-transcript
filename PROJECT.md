# The Transcript Tank — Project SSOT (v1.0)
...
- **Header:** Logo (The Tank) + "Sign In" button
- **Hero Section:**
  - Headline: *Bulk YouTube Transcript Downloader*
  - Sub-headline: *Extract clean text from massive playlists reliably. Fast, free, and built for analysts.*
...
- **Value Prop:** *"Sign in to save your progress and resume large downloads anytime."*
...
- **Primary Button:** Download Combined `.txt` — fastest, combines all text into one file
- **Secondary Button:** Export Individual `.txt` (ZIP) — bundles files using JSZip
- **Closing Call:** *"Finding this useful? [Buy Me a Coffee]."*
...
| **Auto-Cleanup** *(Optional)* | Delete transcripts older than 48 hours for non-supporters to keep the database light. |
